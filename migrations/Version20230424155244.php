 ...
 */
<<<<<<<< HEAD:migrations/Version20230414111549.php
final class Version20230414111549 extends AbstractMigration
========
final class Version20230424155244 extends AbstractMigration
>>>>>>>> origin/bugAdmin:migrations/Version20230424155244.php
{
...
========
        $this->addSql('CREATE TABLE business_hours (id INT AUTO_INCREMENT NOT NULL, day VARCHAR(255) NOT NULL, open_time VARCHAR(30) NOT NULL, close_time VARCHAR(30) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE calendar (id INT AUTO_INCREMENT NOT NULL, name_id INT NOT NULL, start DATETIME NOT NULL, number_of_guests INT NOT NULL, allergie LONGTEXT DEFAULT NULL, allergie_of_guests LONGTEXT DEFAULT NULL, INDEX IDX_6EA9A14671179CD6 (name_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
>>>>>>>> origin/bugAdmin:migrations/Version20230424155244.php
